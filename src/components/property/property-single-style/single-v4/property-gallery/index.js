...
const PropertyGallery = ({ id, imageArray, doc }) => {
  return (
    <>
          ...
          <div className="col-lg-12">
            <div className="ps-v4-hero-tab position-relative">
              ...
              >
                ...
                {doc[0]?.propertyFeilds?.virtualTour && (
                  <li className="nav-item" role="presentation">
                    <button
                      className="nav-link"
      ...
      <div className="ps-v4-hero-tab">
        <div className="tab-content overflow-visible" id="pills-tabContent2">
              ...
              <div className="row" data-aos="fade-up" data-aos-delay="300">
                <div className="col-lg-12">
                  <div className="ps-v4-hero-slider">
                    <GalleryBox id={id} imageArray={imageArray} />
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            <RealMapView link={doc[0]?.propertyFeilds?.virtualTour} />
          </div>
        </div>
        {/* End tab-content */}
      </div>
